...
class ButtonTokens {
  ...
  // Padding
  static const EdgeInsets paddingSmall = EdgeInsets.symmetric(horizontal: 12, vertical: 6);
  static const EdgeInsets paddingMedium = EdgeInsets.symmetric(horizontal: 20, vertical: 10);
  static const EdgeInsets paddingLarge = EdgeInsets.symmetric(horizontal: 24, vertical: 14);
...
class InputTokens {
  ...
  // Padding
  static const EdgeInsets contentPadding = EdgeInsets.symmetric(horizontal: 16, vertical: 16);
