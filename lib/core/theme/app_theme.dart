  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        ...
        iconTheme: const IconThemeData(color: AppColors.textPrimaryLight, size: AppSpacing.iconMd),
      ),
      ...
      navigationBarTheme: NavigationBarThemeData(
        ...
        labelTextStyle: WidgetStateProperty.all(AppTextStyles.labelMedium.copyWith(color: AppColors.textPrimaryLight)),
        iconTheme: WidgetStateProperty.all(const IconThemeData(color: AppColors.textPrimaryLight)),
      ),
      cardTheme: CardThemeData(
        color: AppColors.cardBackgroundLight,
        elevation: 0,
        shape: RoundedRectangleBorder(borderRadius: AppRadius.card, side: const BorderSide(color: AppColors.borderLightMode, width: 1)),
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          padding: const EdgeInsets.symmetric(horizontal: AppSpacing.buttonHorizontalPadding, vertical: 16),
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          ...
          padding: const EdgeInsets.symmetric(horizontal: AppSpacing.buttonHorizontalPadding, vertical: AppSpacing.buttonVerticalPadding),
          shape: RoundedRectangleBorder(borderRadius: AppRadius.button),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        contentPadding: const EdgeInsets.symmetric(horizontal: AppSpacing.inputHorizontalPadding, vertical: AppSpacing.inputVerticalPadding),
        border: OutlineInputBorder(borderRadius: AppRadius.input, borderSide: const BorderSide(color: AppColors.inputBorderLight)),
        enabledBorder: OutlineInputBorder(borderRadius: AppRadius.input, borderSide: const BorderSide(color: AppColors.inputBorderLight)),
        focusedBorder: OutlineInputBorder(borderRadius: AppRadius.input, borderSide: const BorderSide(color: AppColors.inputFocusBorder, width: 2)),
        errorBorder: OutlineInputBorder(borderRadius: AppRadius.input, borderSide: const BorderSide(color: AppColors.error)),
        focusedErrorBorder: OutlineInputBorder(borderRadius: AppRadius.input, borderSide: const BorderSide(color: AppColors.error, width: 2)),
      ...
      chipTheme: ChipThemeData(
        ...
        shape: RoundedRectangleBorder(borderRadius: AppRadius.chip, side: BorderSide.none),
      ),
      dialogTheme: DialogThemeData(
        backgroundColor: AppColors.surfaceLightMode,
        elevation: 24,
        shape: RoundedRectangleBorder(borderRadius: AppRadius.modal),
        titleTextStyle: AppTextStyles.headlineSmall.copyWith(color: AppColors.textPrimaryLight),
      ...
      progressIndicatorTheme: ProgressIndicatorThemeData(color: AppColors.primary, linearTrackColor: AppColors.progressBackground, circularTrackColor: AppColors.progressBackground),
      snackBarTheme: SnackBarThemeData(
        backgroundColor: AppColors.textPrimaryLight,
        contentTextStyle: AppTextStyles.bodyMedium.copyWith(color: AppColors.surfaceLightMode),
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        ...
        iconTheme: const IconThemeData(color: AppColors.textPrimary, size: AppSpacing.iconMd),
      ),
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        backgroundColor: AppColors.surface,
        selectedItemColor: AppColors.primary,
      ...
      navigationBarTheme: NavigationBarThemeData(
        ...
        labelTextStyle: WidgetStateProperty.resolveWith((states) => AppTextStyles.labelSmall.copyWith(color: states.contains(WidgetState.selected) ? AppColors.primary : AppColors.textMuted)),
        iconTheme: WidgetStateProperty.resolveWith((states) => IconThemeData(color: states.contains(WidgetState.selected) ? AppColors.primary : AppColors.textMuted, size: 24)),
      ),
      cardTheme: CardThemeData(
        color: AppColors.cardBackground,
        elevation: 0,
        shape: RoundedRectangleBorder(borderRadius: AppRadius.card, side: const BorderSide(color: AppColors.border, width: 1)),
        margin: EdgeInsets.zero,
      ),
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        contentPadding: const EdgeInsets.symmetric(horizontal: AppSpacing.inputHorizontalPadding, vertical: AppSpacing.inputVerticalPadding),
        border: OutlineInputBorder(borderRadius: AppRadius.input, borderSide: const BorderSide(color: AppColors.inputBorder)),
        enabledBorder: OutlineInputBorder(borderRadius: AppRadius.input, borderSide: const BorderSide(color: AppColors.inputBorder)),
