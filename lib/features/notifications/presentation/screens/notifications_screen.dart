          ...
          children: [
            ...
            Expanded(
              child: TabBarView(
                ...
                children: [_MessagesTab(), _SystemTab()],
              ),
            ),
          ],
        ),
  ...
  Widget _buildTabBar() {
    return Container(
      ...
      child: TabBar(
        ...
        tabs: const [Tab(text: 'Messages'), Tab(text: 'System')],
      ),
    );
  }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color:
                isRead ? AppColors.border : AppColors.primary.withOpacity(0.2),
          ),
        ),
        child: Row(
          children: [
