...
class DatingProfile {
  ...
  factory DatingProfile.fromFirestore(String uid, Map<String, dynamic> json) {
    ...
    return DatingProfile(
      ...
      educationLevel:
          _pickNullable(json, ['educationLevel', 'education_level']) ??
      ...
      maritalStatus:
          _pickNullable(json, ['maritalStatus', 'marital_status']) ??
          _pickStringFromMap(compat, ['maritalStatus', 'marital_status']),
      haveKids:
          _pickNullable(json, [
            'haveKids',
            'hasKids',
      ...
      genotype:
          _pickNullable(json, ['genotype']) ??
          _pickStringFromMap(compat, ['genotype']),
